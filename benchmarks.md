...
| `norm squared` | 5.74 ns | 1.64 us | 1.62 us | 154.77 ns | 514.36 ns | 285.76x | 10.59x | 3.19x |
| `reciprocal` | 15.98 ns | 3.19 us | 3.22 us | 450.18 ns | 3.08 us | 199.38x | 7.08x | 1.04x |
| `reciprocal checked` | 14.02 ns | 3.18 us | 3.10 us | 453.00 ns | 3.12 us | 226.64x | 7.01x | 1.02x |
...
| `div checked` | 19.52 ns | 6.53 us | 6.72 us | 785.21 ns | 4.19 us | 334.56x | 8.32x | 1.56x |
| `div real checked` | 9.25 ns | 940.02 ns | 812.27 ns | 267.82 ns | 1.82 us | 101.60x | 3.51x | 0.52x |
...
| `mul` | 7.49 ns | 3.47 us | 3.51 us | 304.58 ns | 947.74 ns | 462.57x | 11.38x | 3.66x |
| `div` | 18.15 ns | 6.57 us | 6.73 us | 795.33 ns | 4.35 us | 361.95x | 8.26x | 1.51x |
| `div real` | 9.93 ns | 936.01 ns | 808.87 ns | 267.29 ns | 1.83 us | 94.30x | 3.50x | 0.51x |
...
| Benchmark | Approx | Realistic from f64 | Realistic rational | astro-float 128 | arpfloat 128 | Realistic f64 / approx | Realistic f64 / astro | Realistic f64 / arp |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `vec3 dot` | 6.69 ns | 3.58 us | 6.39 us | 319.82 ns | 862.24 ns | 535.21x | 11.19x | 4.15x |
| `vec3 magnitude` | 9.57 ns | 8.02 us | 11.65 us | 6.03 us | 38.89 us | 838.24x | 1.33x | 0.21x |
| `vec3 normalize` | 24.97 ns | 13.03 us | 14.01 us | 6.33 us | 44.05 us | 521.69x | 2.06x | 0.30x |
...
| `vec3 dot abort` | 27.34 ns | 4.02 us | 4.71 us | 266.58 ns | 827.41 ns | 146.88x | 15.06x | 4.85x |
| `vec3 magnitude abort` | 38.65 ns | 8.47 us | 7.89 us | 5.85 us | 39.17 us | 219.28x | 1.45x | 0.22x |
| `vec3 normalize checked` | 25.75 ns | 13.51 us | 10.75 us | 6.30 us | 43.28 us | 524.63x | 2.14x | 0.31x |
| `vec3 normalize checked abort` | 60.81 ns | 13.90 us | 11.15 us | 6.31 us | 43.38 us | 228.61x | 2.20x | 0.32x |
...
| Benchmark | Approx | Realistic from f64 | Realistic rational | astro-float 128 | arpfloat 128 | Realistic f64 / approx | Realistic f64 / astro | Realistic f64 / arp |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `mat3 determinant` | 15.85 ns | 9.25 us | 4.25 us | 1.07 us | 2.64 us | 583.44x | 8.68x | 3.50x |
| `mat3 inverse` | 78.58 ns | 34.13 us | 14.28 us | 3.49 us | 11.05 us | 434.39x | 9.79x | 3.09x |
| `mat3 mul mat3` | 76.27 ns | 28.47 us | 15.85 us | 2.89 us | 8.20 us | 373.30x | 9.84x | 3.47x |
| `mat3 transform vec3` | 15.68 ns | 11.50 us | 12.32 us | 1.15 us | 2.76 us | 733.18x | 10.03x | 4.17x |
| `mat4 determinant` | 44.46 ns | 19.92 us | 8.19 us | 5.13 us | 11.24 us | 448.01x | 3.88x | 1.77x |
| `mat4 inverse` | 147.65 ns | 83.07 us | 27.90 us | 12.07 us | 40.73 us | 562.60x | 6.88x | 2.04x |
| `mat4 mul mat4` | 120.23 ns | 43.66 us | 22.18 us | 6.86 us | 19.17 us | 363.10x | 6.36x | 2.28x |
| `mat4 transform vec4` | 25.03 ns | 15.26 us | 5.31 us | 2.05 us | 5.10 us | 609.65x | 7.43x | 2.99x |
...
| `mat3 transpose` | 8.74 ns | 1.04 us | 1.04 us | 311.95 ns | 207.15 ns | 118.46x | 3.32x | 5.00x |
...
| `mat3 inverse checked` | 78.74 ns | 34.81 us | 40.51 us | 3.12 us | 10.92 us | 442.10x | 11.17x | 3.19x |
| `mat3 inverse checked abort` | 118.91 ns | 34.46 us | 40.08 us | 3.13 us | 10.86 us | 289.81x | 11.01x | 3.17x |
...
| `mat3 div matrix checked` | 119.27 ns | 79.55 us | 77.36 us | 5.69 us | 19.54 us | 666.94x | 13.98x | 4.07x |
| `mat3 div matrix checked abort` | 131.90 ns | 79.81 us | 76.50 us | 5.70 us | 19.57 us | 605.04x | 13.99x | 4.08x |
...
| `mat3 div matrix` | 114.94 ns | 80.08 us | 76.76 us | 5.64 us | 19.79 us | 696.68x | 14.21x | 4.05x |
...
| `mat4 transpose` | 9.20 ns | 1.71 us | 1.71 us | 534.26 ns | 354.28 ns | 186.40x | 3.21x | 4.84x |
| `mat4 reciprocal` | 166.78 ns | 81.05 us | 80.97 us | 11.51 us | 40.19 us | 485.99x | 7.04x | 2.02x |
| `mat4 reciprocal checked` | 149.42 ns | 81.44 us | 80.65 us | 11.53 us | 40.36 us | 545.05x | 7.06x | 2.02x |
...
| `mat4 div matrix` | 191.07 ns | 156.66 us | 128.57 us | 17.84 us | 60.75 us | 819.91x | 8.78x | 2.58x |
...
| Benchmark | Approx | Realistic from f64 | Realistic rational | astro-float 128 | arpfloat 128 | Realistic f64 / approx | Realistic f64 / astro | Realistic f64 / arp |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `scalar add owned_ref` | 8.93 ns | 367.56 ns | 369.53 ns | - | - | 41.18x | - | - |
| `scalar add ref_owned` | 5.48 ns | 394.61 ns | 374.86 ns | - | - | 71.97x | - | - |
| `scalar add refs` | 5.33 ns | 376.57 ns | 372.78 ns | - | - | 70.67x | - | - |
| `scalar sub owned_ref` | 9.02 ns | 635.34 ns | 425.49 ns | - | - | 70.43x | - | - |
| `scalar sub ref_owned` | 5.66 ns | 724.74 ns | 515.42 ns | - | - | 128.04x | - | - |
| `scalar sub refs` | 5.54 ns | 633.95 ns | 426.68 ns | - | - | 114.50x | - | - |
| `scalar mul owned_ref` | 9.62 ns | 427.84 ns | 318.79 ns | - | - | 44.46x | - | - |
| `scalar mul ref_owned` | 7.76 ns | 423.19 ns | 314.66 ns | - | - | 54.53x | - | - |
| `scalar mul refs` | 6.25 ns | 428.51 ns | 311.95 ns | - | - | 68.60x | - | - |
| `scalar div owned_ref` | 15.39 ns | 343.26 ns | 199.80 ns | - | - | 22.30x | - | - |
| `scalar div ref_owned` | 8.00 ns | 445.66 ns | 305.67 ns | - | - | 55.72x | - | - |
| `scalar div refs` | 6.82 ns | 341.60 ns | 195.11 ns | - | - | 50.09x | - | - |
| `vec3 add refs` | 6.33 ns | 2.11 us | 1.90 us | - | - | 333.89x | - | - |
| `vec3 sub refs` | 6.19 ns | 2.21 us | 1.95 us | - | - | 357.16x | - | - |
| `vec3 neg ref` | 3.28 ns | 257.93 ns | 251.78 ns | - | - | 78.68x | - | - |
| `vec3 add_scalar_ref` | 6.43 ns | 1.82 us | 1.66 us | - | - | 283.19x | - | - |
| `vec3 sub_scalar_ref` | 6.49 ns | 1.57 us | 1.47 us | - | - | 241.30x | - | - |
| `vec3 mul_scalar_ref` | 6.92 ns | 1.96 us | 2.00 us | - | - | 283.66x | - | - |
| `vec3 div_scalar_ref` | 9.68 ns | 1.78 us | 1.63 us | - | - | 183.87x | - | - |
| `vec4 add refs` | 6.36 ns | 2.35 us | 1.99 us | - | - | 370.56x | - | - |
| `vec4 sub refs` | 3.06 ns | 2.21 us | 1.86 us | - | - | 720.94x | - | - |
| `vec4 neg ref` | 4.23 ns | 328.80 ns | 318.13 ns | - | - | 77.75x | - | - |
| `vec4 add_scalar_ref` | 6.89 ns | 1.98 us | 1.69 us | - | - | 287.48x | - | - |
| `vec4 sub_scalar_ref` | 4.20 ns | 1.74 us | 1.47 us | - | - | 414.80x | - | - |
| `vec4 mul_scalar_ref` | 7.34 ns | 2.13 us | 2.03 us | - | - | 290.61x | - | - |
| `vec4 div_scalar_ref` | 13.87 ns | 2.01 us | 1.70 us | - | - | 144.71x | - | - |
| `mat3 add refs` | 12.43 ns | 5.36 us | 6.15 us | - | - | 431.63x | - | - |
| `mat3 sub refs` | 12.32 ns | 5.58 us | 6.12 us | - | - | 452.97x | - | - |
| `mat3 mul refs` | 79.51 ns | 28.62 us | 37.81 us | - | - | 359.94x | - | - |
| `mat3 div refs` | 115.82 ns | 80.04 us | 76.89 us | - | - | 691.13x | - | - |
| `mat3 neg ref` | 9.49 ns | 1.08 us | 1.10 us | - | - | 113.42x | - | - |
| `mat3 add_scalar_ref` | 10.23 ns | 5.02 us | 5.83 us | - | - | 490.38x | - | - |
| `mat3 sub_scalar_ref` | 12.81 ns | 5.65 us | 5.69 us | - | - | 441.07x | - | - |
| `mat3 mul_scalar_ref` | 11.89 ns | 5.25 us | 5.94 us | - | - | 441.44x | - | - |
| `mat3 div_scalar_ref` | 24.38 ns | 5.46 us | 5.58 us | - | - | 224.12x | - | - |
| `mat4 add refs` | 50.04 ns | 6.90 us | 7.11 us | - | - | 137.92x | - | - |
| `mat4 sub refs` | 36.84 ns | 7.42 us | 7.17 us | - | - | 201.35x | - | - |
| `mat4 mul refs` | 118.43 ns | 43.41 us | 48.56 us | - | - | 366.56x | - | - |
| `mat4 div refs` | 192.39 ns | 157.50 us | 128.25 us | - | - | 818.67x | - | - |
| `mat4 neg ref` | 12.52 ns | 2.04 us | 2.00 us | - | - | 163.17x | - | - |
| `mat4 add_scalar_ref` | 14.10 ns | 7.49 us | 8.02 us | - | - | 531.15x | - | - |
| `mat4 sub_scalar_ref` | 14.96 ns | 8.76 us | 7.99 us | - | - | 585.18x | - | - |
| `mat4 mul_scalar_ref` | 48.80 ns | 7.53 us | 7.85 us | - | - | 154.26x | - | - |
| `mat4 div_scalar_ref` | 29.36 ns | 8.64 us | 7.84 us | - | - | 294.10x | - | - |
| `mat3 transform_vec refs` | 16.16 ns | 11.71 us | 13.65 us | - | - | 724.48x | - | - |
| `mat4 transform_vec refs` | 25.70 ns | 15.67 us | 14.87 us | - | - | 609.74x | - | - |
| `complex add refs` | 7.62 ns | 958.66 ns | 987.65 ns | - | - | 125.80x | - | - |
| `complex sub refs` | 7.99 ns | 1.09 us | 967.13 ns | - | - | 136.51x | - | - |
| `complex mul refs` | 8.02 ns | 3.24 us | 3.50 us | - | - | 404.04x | - | - |
| `complex div refs` | 18.75 ns | 6.28 us | 6.73 us | - | - | 334.97x | - | - |
| `complex neg ref` | 2.35 ns | 123.63 ns | 106.80 ns | - | - | 52.60x | - | - |
| `complex div_real_ref` | 9.94 ns | 841.76 ns | 790.83 ns | - | - | 84.71x | - | - |
